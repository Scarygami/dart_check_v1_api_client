part of check_v1_api_console;

/** Client to access the check v1 API */
/** Discovery Check API */
class Check extends ConsoleClient {
  ...
  Check([Object auth]) : super(auth) {
    basePath = "/_ah/api/check/v1/";
    rootUrl = "https://discovery-check.appspot.com/";
